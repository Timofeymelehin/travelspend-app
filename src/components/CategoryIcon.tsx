...
export const PaymentMethodBadge: React.FC<{ method: string; className?: string }> = ({
  ...
  switch (method) {
    ...
    case 'prepaid':
      return (
        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-medium bg-sky-500/15 text-sky-300 border border-sky-500/30 ${className}`}>
